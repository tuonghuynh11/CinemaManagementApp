import {
  ...
  export default function ActorModal({ visible, hide, uploadImage }) {
    ...
    const [validateCName, setValidateCName] = useState(true);
    const [CName, setCName] = useState("");
    const CNameHandler = (val) => {
      setCName(val);
    ...
    return (
      ...
      >
        ...
        <View style={styles.lower}>
          <Text style={styles.textLabel}>Actor Name</Text>
          <TextInput
          ...
          <Text style={styles.textLabel}>Charater Name</Text>
          <TextInput
            placeholderTextColor="#a28012"
            style={
              validateCName == true ? styles.textInput : styles.textInputWrong
            }
            placeholder="Enter Charater Name"
            value={CName}
            onChangeText={CNameHandler}
          ></TextInput>
          {!validateCName && (
            <Text style={styles.validateText}>This field can't be empty</Text>
          )}
